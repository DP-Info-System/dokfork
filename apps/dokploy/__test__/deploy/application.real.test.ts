...
import type { ApplicationNested } from "@dpploy/server";
import { paths } from "@dpploy/server/constants";
import { execAsync } from "@dpploy/server/utils/process/execAsync";
...
vi.mock("@dpploy/server/services/admin", () => ({
	getDPPloyUrl: vi.fn().mockResolvedValue("http://localhost:3000"),
}));
