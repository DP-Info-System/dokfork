import type { ApplicationNested } from "@dpploy/server/utils/builders";
import { mechanizeDockerContainer } from "@dpploy/server/utils/builders";
...
vi.mock("@dpploy/server/utils/servers/remote-docker", () => ({
