...
const TEMPLATE_BASE_URL_KEY = "dpploy_template_base_url";
								...
								{templates?.map((template, idx) => (
									...
									>
										...
										>
											...
											<img
												src={`${customBaseUrl || "https://templates.dpploy.com/"}/blueprints/${template?.id}/${template?.logo}`}
												className={cn(
													"object-contain",
															...
															<div>
																...
																>
																	<SelectTrigger>
																		<SelectValue
																			placeholder={
																				!isCloud ? "DPPloy" : "Select a Server"
																			}
																		/>
																	</SelectTrigger>
																	<SelectContent>
