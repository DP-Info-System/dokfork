...
export default function Page({ children }: Props) {
	...
	const isInactive = licenseStatus !== "active";
					...
					<SidebarGroup>
						...
						<SidebarMenu>
							{filteredHome.map((item) => {
								...
								const isSubscriptionItem = item.url === "/subscription";
								const isDisabled = isInactive && !isSubscriptionItem;
								...
								return (
									<Collapsible
										...
										className={cn("group/collapsible", isDisabled && "opacity-50 pointer-events-none")}
									>
										<SidebarMenuItem>
											{isSingle ? (
												<SidebarMenuButton
