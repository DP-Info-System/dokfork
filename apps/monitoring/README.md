# DPPloy Monitoring (Go Version)

Application that powers DPPloy's monitoring service.
...
DPPloy uses a callback URL to send notifications when metrics exceed configured thresholds. Notifications are sent via POST request in the following format:
