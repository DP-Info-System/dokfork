...
export const notifications = pgTable("notification", {
	...
	dpployRestart: boolean("dpployRestart").notNull().default(false),
	dpployBackup: boolean("dpployBackup").notNull().default(false),
...
export const apiUpdatePushover = z.object({
	...
	dpployBackup: z.boolean().optional(),
	volumeBackup: z.boolean().optional(),
	dpployRestart: z.boolean().optional(),
